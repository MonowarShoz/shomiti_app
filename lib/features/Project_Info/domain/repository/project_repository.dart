...
import '../../data/datasource/remote/model/member_assign_model.dart';
...
abstract class ProjectRepository {
  ...
  Future<ApiResult<String?>> saveMemberAssignToProject({required int id,required int projectId, required int memNo, required int amount});
}
