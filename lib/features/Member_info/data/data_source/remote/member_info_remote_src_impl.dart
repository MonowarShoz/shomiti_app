...
class MemberInfoRemoteSrcImpl extends BaseRemoteDataSource implements MemberInfoRemoteSource{
  ...
  @override
  Future<ApiResult<List<MemberInfoAllModel>?>> memberInfoAll({required String token, required int companyId}) {
    return safeApiCall(() async{
      return await apiService.getAllMemberInfoData(token, companyId);
    },);
  }
